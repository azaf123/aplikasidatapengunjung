                ...
                <div id="auth-left">
                    ...
                    <form method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" class="form-control @error('fullname') is-invalid @enderror form-control-xl" placeholder="Nama Petugas" name="fullname">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" class="form-control @error('confirm_password') is-invalid @enderror form-control-xl" placeholder="Confirm Password" name="retypepassword">
                            <div class="form-control-icon">
                                <i class="bi bi-shield-lock"></i>
                            </div>
                        </div>
